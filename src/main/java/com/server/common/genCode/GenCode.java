   ...
   /* private void processAllMethod(StringBuffer sb) {
    ...
    public static void main(String[] args) {
        try {
            ...
            INSTANCE.packageOutPath = "com.server.module.system.visionManage.visionCheck";// 指定实体生成所在包的路径
            INSTANCE.zwtitle="视觉检测";
            INSTANCE.generate("vision_machines_check");//表名
